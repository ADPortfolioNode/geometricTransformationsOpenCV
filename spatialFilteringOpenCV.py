...
#MEDIAN
#Median filters find the median of all the pixels under the kernel area and the central element is replaced with this median value. This is effective in reducing salt-and-pepper noise in images.
...
#Now let's apply a Median Filter by using the medianBlur function. The parameters for this function are src: The image and ksize: Kernel size which should be odd and positive. The function returns the filtered image.
